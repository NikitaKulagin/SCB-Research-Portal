...
- **Файл**: `index.html` (язык: html)
  - Html: **index.html**
    - *Описание:* HTML файл
    - *Импорты:* /SCB-Research-Portal/favicon.ico, /SCB-Research-Portal/static/js/main.cd0e90b2.js
...
### Папка: `research-portal/build/pdfs`
Содержимые файлы:
- Макромонитор 2025.02.03.pdf
- Рынок пшеницы 2025.02.01.pdf
- Рынок стали 2025.01.01.pdf

### Папка: `research-portal/build/static`
*(Нет файлов)*

### Папка: `research-portal/build/static/css`
Содержимые файлы:
- main.630bb695.css
- main.630bb695.css.map

### Папка: `research-portal/build/static/js`
Содержимые файлы:
- 488.3cdc2af1.chunk.js
- 488.3cdc2af1.chunk.js.map
- main.cd0e90b2.js
...
### Папка: `research-portal/build/thumbnails`
Содержимые файлы:
- Макромонитор 2025.02.03.png
- Рынок пшеницы 2025.02.01.png
- Рынок стали 2025.01.01.png
...
- **Файл**: `index.js` (язык: js)
  - File_imports: **index.js**
    - *Импорты:* ./reportWebVitals, ./App, ./AuthContext
...
- **Файл**: `App.js` (язык: js)
  - Function: **App**
  - File_imports: **App.js**
    - *Импорты:* ./AdminDashboard, ./AdminRoute, ./ResearchDetail, ./Register, ./Home, ./Login, ./PrivateRoute, ./Research, ./NotFound, ./initData
